	...
	if(empty($admin)) {
		...
		if(empty($gettime['githubapi']) || $gettime['githubapi'] >= $time+21600) {
			...
			if (extension_loaded('openssl')) {
				...
				$current_tags = file_get_contents("https://api.github.com/repos/marcosppastor/cms-website-ms/tags", false, $context);
				if ($current_tags) {
					...
					if ($current_tag == $ref_tag) {
						...
						$alert_class = "info";
						$version_message = "<a href=\"https://github.com/marcosppastor/cms-website-ms\" class=\"alert-link\">Update Available &raquo;</a>";
						$status = 1;
					}
				} else {
					$alert_class = "danger";
